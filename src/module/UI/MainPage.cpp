...
MainPage::MainPage()
{
    ...
    LvLabel face_icon_label{face_container.raw(), "face_scurity", lv_color_white()};
    ...
    LvLabel security_camera_icon_label{security_camera_container.raw(), "IPC", lv_color_white()};
}
